...
// TODO: replace with @available
    ...
    public struct BulkPresetsPicker<Key, PresettedItem, Label>: View
    ...
    struct BulkPresetsPicker_Previews: PreviewProvider {
        struct TestHolder: View {
            ...
            var body: some View {
                NavigationStack {
                    BulkPresetsPicker(selected: $selected, presets: presets) {
                        Text($0.text)
                    }
                }
            }
